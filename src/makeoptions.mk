...
LIB_MIP     = -L$(PATH_GUROBI)/lib -lgurobi_g++5.2 -lgurobi81 -pthread
INC_MIP     = -I$(PATH_GUROBI)/include
FLAG_MIP   = -DMC__USE_GUROBI

FLAG_DEP = -fPIC $(FLAG_MC) $(FLAG_BOOST) $(FLAG_MIP) $(FLAG_SOBOL) 
LIB_DEP  = $(LIB_MC) $(LIB_PROFIL) $(LIB_BOOST) $(LIB_MIP) $(LIB_IPOPT) $(LIB_SUNDIALS) $(LIB_SOBOL)
INC_DEP  = $(INC_MC) $(INC_PROFIL) $(INC_BOOST) $(INC_MIP) $(INC_IPOPT) $(INC_SUNDIALS) $(INC_SOBOL)
