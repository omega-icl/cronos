...
int main()
{
  ...
  I Ip[NP] = { I( 0.1, 2.0 ) };
  for( unsigned i=1; i<NP; i++ ) Ip[i] = ( i==4? I( 0. ): I( -4., 4. ) );
  //double p0[NP] = { 0.5 };
  //for( unsigned i=1; i<NX; i++ ) p0[i] = ( i==4? 0.: 0.4 );
