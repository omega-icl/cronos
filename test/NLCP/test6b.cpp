...
//  CP.options.CMODSPAR    = true;//false;//
  ...
  CP.options.CMODEL.MIXED_IA = true ; //false;
  std::cout << CP;
  ...
  const I Ip[NP] = { I(1e-3,1.5), I(0.,0.6), I(0.,0.8), I(0.,5.), I(0.,80.), I(40.,50.), I(0.,60.) };
  //const I Ip[NP] = { I(0.7505,1.5), I(0.,0.6), I(0.,0.8), I(0.,5.), I(0.,80.), I(40.,50.), I(0.,60.) };
  //const I Ip[NP] = { I(5.16281e-01,5.63125e-01), I(0.00000e+00,6.25097e-03), I(5.53157e-01,5.81691e-01),
  //                   I(4.97892e+00,5.00000e+00), I(4.29221e+00,5.78887e+00), I(40.,50.), I(5.03125e+01,5.10938e+01) };
