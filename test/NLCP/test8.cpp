...
( const typename mc::NLCP<I>::NODE*pNode )
{
  ...
  for( unsigned i=1; i<=nc*ns; i++ ){
    ...
    if( pNode->depend().find(i) == pNode->depend().end()
     && mc::Op<I>::diam(pNode->P(i)) > maxw )
      maxw = mc::Op<I>::diam(pNode->P(i));
  }
...
/*
  const I Ip_3stg[NP] = { I(4.518816e-01,4.534009e-01), I(8.516051e-01,8.523648e-01),
                          I(7.981340e-01,8.005287e-01), I(4.403850e-01,4.595697e-01),
                          I(2.956427e-02,2.992339e-02), I(5.119010e-02,5.199306e-02),
                          I(1.573896e-01,1.626762e-01), I(1.180650e-01,1.184726e-01),
                          I(1.485097e-01,1.498436e-01), I(3.826016e-01,3.958223e-01),
                          I(1.026869e+00,1.027491e+00), I(1.074423e+00,1.076641e+00),
                          I(1.757757e+00,1.823703e+00), I(5.519611e-01,5.529273e-01),
                          I(4.907930e-01,4.930255e-01), I(3.056656e-01,3.099213e-01),
                          I(9.155614e-01,9.179691e-01), I(7.685305e-01,7.737175e-01),
                          I(3.651869e-01,3.741175e-01), I(1.053602e+00,1.054078e+00),
                          I(1.091272e+00,1.093067e+00), I(1.655464e+00,1.709251e+00),
                          I(2.150115e+00,2.154206e+00), I(1.891723e+00,1.901128e+00),
                          I(1.086386e+00,1.106048e+00), I(4.299688e+00,4.311628e+00),
                          I(3.572733e+00,3.598222e+00), I(1.570437e+00,1.620828e+00),
                          I(3.367037e+02,3.367077e+02), I(3.369600e+02,3.369708e+02),
                          I(3.388741e+02,3.390118e+02) };
  const I Ip_3stg[NP] = { 
...
I(1.05360200000000e+00,1.05407800000000e+00),
I(1.09127200000000e+00,1.09306700000000e+00),
I(1.65546400000000e+00,1.70925100000000e+00),
I(2.15011500000000e+00,2.15420600000000e+00),
I(1.89172300000000e+00,1.90112800000000e+00),
I(1.08638600000000e+00,1.10604800000000e+00),
I(4.29968800000000e+00,4.31162800000000e+00),
I(3.57273300000000e+00,3.59822200000000e+00),
I(1.57043700000000e+00,1.61683598098174e+00),
...
try{
  ...
  std::ofstream K_un( "test8.out", std::ios_base::out );
