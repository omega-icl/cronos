...
BOUNDIdata   = 'test0_DINEQI_STA.dat'
BOUNDPMdata  = 'test0_DINEQPM_STA.dat'

set output "test0_DINEQ_STA.eps"
...
!ps2eps -B -f -l test0_DINEQ_STA.eps
!mv test0_DINEQ_STA.eps.eps test0_DINEQ_STA.eps
!gv test0_DINEQ_STA.eps
