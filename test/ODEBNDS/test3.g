...
set output "test3_DINEQI_STA.eps"
...
unset multiplot
!ps2eps -B -f -l test3_DINEQI_STA.eps
!mv test3_DINEQI_STA.eps.eps test3_DINEQI_STA.eps 

SAMPLINGdata = 'test3_APPROX_ADJ.dat'
BOUNDINGdata = 'test3_DINEQI_ADJ.dat'

set output "test3_DINEQI_ADJ.eps"
...
unset multiplot
!ps2eps -B -f -l test3_DINEQI_ADJ.eps
!mv test3_DINEQI_ADJ.eps.eps test3_DINEQI_ADJ.eps 
