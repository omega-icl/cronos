...
BOUNDINGdata = 'test4_DINEQPM_STA.dat'

set output "test4_DINEQPM_STA.eps"
...
unset multiplot
!ps2eps -B -f -l test4_DINEQPM_STA.eps
!mv test4_DINEQPM_STA.eps.eps test4_DINEQPM_STA.eps 

SAMPLINGdata = 'test4_APPROX_ADJ.dat'
BOUNDINGdata = 'test4_DINEQPM_ADJ.dat'

set output "test4_DINEQPM_ADJ.eps"
...
unset multiplot
!ps2eps -B -f -l test4_DINEQPM_ADJ.eps
!mv test4_DINEQPM_ADJ.eps.eps test4_DINEQPM_ADJ.eps 
