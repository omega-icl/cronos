...
set output "test5_DINEQPM_STA.eps"
...
unset multiplot
!ps2eps -B -f -l test5_DINEQPM_STA.eps
!mv test5_DINEQPM_STA.eps.eps test5_DINEQPM_STA.eps 

SAMPLINGdata = 'test5_APPROX_ADJ.dat'
BOUNDINGdata = 'test5_DINEQI_ADJ.dat'
BOUNDINGdata2 = 'test5_DINEQPM_ADJ.dat'

set output "test5_DINEQPM_ADJ.eps"
...
#}
unset multiplot
!ps2eps -B -f -l test5_DINEQPM_ADJ.eps
!mv test5_DINEQPM_ADJ.eps.eps test5_DINEQPM_ADJ.eps 
