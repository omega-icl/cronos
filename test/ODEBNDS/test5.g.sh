...
set term post eps enh color solid 5


set output sprintf("%s_STA.eps","$DATA")
set multiplot layout M-1,NX title "States"
...
set multiplot layout M-1,M title "Adjoint Sensitivities"
set style fill transparent solid 0.65 noborder
do for [j = 1:NF]{
  do for [i = 1:NX]{
    set xlabel "t"
...
set multiplot layout M-1,M title "Forward Sensitivities"
set style fill transparent solid 0.65 noborder
do for [j = 1:NP]{
  do for [i = 1:NX]{
    set xlabel "t"
