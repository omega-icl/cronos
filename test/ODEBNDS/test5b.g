...
SAMPLINGdata = 'test5b_APPROX_STA.dat'
BOUNDINGdata = 'test5b_DINEQI_STA.dat'
BOUNDINGdata2 = 'test5b_DINEQPM_STA.dat'

set output "test5b_DINEQPM_STA.eps"
...
unset multiplot
!ps2eps -B -f -l test5b_DINEQPM_STA.eps
!mv test5b_DINEQPM_STA.eps.eps test5b_DINEQPM_STA.eps 

SAMPLINGdata = 'test5b_APPROX_ADJ.dat'
BOUNDINGdata = 'test5b_DINEQI_ADJ.dat'
BOUNDINGdata2 = 'test5b_DINEQPM_ADJ.dat'

set output "test5b_DINEQPM_ADJ.eps"
...
#}
unset multiplot
!ps2eps -B -f -l test5b_DINEQPM_ADJ.eps
!mv test5b_DINEQPM_ADJ.eps.eps test5b_DINEQPM_ADJ.eps 
